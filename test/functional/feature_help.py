...
"""Verify that starting varsechaind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start varsechaind with -h for help text")
        ...
        self.log.info("Start varsechaind with -version for version information")
