...
from test_framework.test_framework import VarsechainTestFramework
...
class LLMQChainLocksTest(VarsechainTestFramework):
    def set_test_params(self):
        self.set_varsechain_test_params(6, 5, fast_dip3_enforcement=True)
