...
This document provides guidelines for internationalization of the Varsechain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `varsechain_en.ts` remains unchanged.
