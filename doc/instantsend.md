...
This mechanism has been integrated into Bitcore-Node-Varsechain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gitvarse/insight-api-varsechain#web-socket-api](https://github.com/gitvarse/insight-api-varsechain#web-socket-api)
* API: [https://github.com/gitvarse/insight-api-varsechain#instantsend-transactions](https://github.com/gitvarse/insight-api-varsechain#instantsend-transactions)
