...
* varsechain.conf: contains configuration settings for varsechaind or varsechain-qt
* varsechaind.pid: stores the process id of varsechaind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by varsechaind or varsechain-qt
