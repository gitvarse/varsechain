...
{
    const char* pszTimestamp = "The Varsechain is name of the game for new generation of firms on mainet 01618007";
    const CScript genesisOutputScript = CScript() << ParseHex("0459b89eaf48a1d2452b9b6317f528b1d13db1b55cb0700e49673cf90e7b7da1b31735a571bd0d52b92077e10b7075e4022df2e60f9506a7ca1eb816a7586b0d12") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Varsechain: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Varsechain: 2 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0x001a580182d519baba2f71346f19c7ca1bcde3fdc494b1696a29ffd50a8dda8a"); // block hash for 0
         ...
         */
        pchMessageStart[0] = 0x72;//V
        pchMessageStart[1] = 0x74;//A
        pchMessageStart[2] = 0x6d;//R
        pchMessageStart[3] = 0x2e;//S
        nDefaultPort = 17088;
        nPruneAfterHeight = 100000;
        genesis = CreateGenesisBlock(1692004970, 4201, 0x20001fff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xff5797ce80fe7fb5d6b1b289c52c7bc73b42d0dcfbb568a350a050d353103f43"));
        assert(genesis.hashMerkleRoot == uint256S("0x7d18ebea1b2993fbd5fb4cedf9f9f31edb7f2825f110834299012f15930ddcb0"));

        vSeeds.emplace_back("varse.varsechain.com");


        // Varsechain addresses start with 'V'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,70);
        // Varsechain script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Varsechain private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Varsechain BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Varsechain BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Varsechain BIP44 coin type is '5'
...
//        }
        ...
        vSporkAddresses = {"VSxgorrqmAgBrFbFrd4QhoBrbdnsdU8gxj"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1692004970,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Varsechain: 1 day
        consensus.nPowTargetSpacing = 60; // Varsechain: 1 minutes
        ...
        pchMessageStart[1] = 0x72; //v
        pchMessageStart[2] = 0x74; //a
        pchMessageStart[3] = 0x6d; //r
        nDefaultPort = 17229;
        ...
        vSeeds.emplace_back("ndtest.varsechain.com");

        // Testnet Varsechain addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,123);
        // Testnet Varsechain script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Varsechain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Varsechain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Varsechain BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
...
//      std::cout << "hash: " << consensus.hashGenesisBlock.ToString() << std::endl;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("varsechainevo.org",  "devnet-seed.varsechainevo.org"));

        // Testnet Varsechain addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Varsechain addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Varsechain script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Varsechain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Varsechain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Varsechain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
