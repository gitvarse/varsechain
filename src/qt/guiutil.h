...
/** Utility functions used by the Varsechain Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "varsechain:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load varsechain specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a varsechain specific theme is activated (light/dark).*/
