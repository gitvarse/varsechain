    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  varsechain-qt [command-line options]                     \n";
...
All the Varsechain in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 VARSE, 0.01 VARSE, 0.1 VARSE, 1 VARSE and 10 VARSE -- sort of like the paper money you use every day.</li> \
