...
#ifndef VARSECHAIN_ARITH_UINT256_H
#define VARSECHAIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Varsechain only uses this "compact" format for encoding difficulty
...
#endif // VARSECHAIN_ARITH_UINT256_H
