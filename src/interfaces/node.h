...
//! Interface for the src/evo part of a varsechain node (varsechaind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a varsechain node (varsechaind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a varsechain node (varsechaind process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a varsechain node (varsechaind process).
class Node
{
public:
    virtual ~Node() {}
