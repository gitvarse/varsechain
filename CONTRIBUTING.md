Contributing to Varsechain Core
============================

The Varsechain Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to varsechain-qt
...
[Translation Process](https://github.com/gitvarse/varsechain/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Varsechain Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Varsechain
Network Protocol consensus changes.

Whether a pull request is merged into Varsechain Core rests with the project merge
...
Patches that change Varsechain consensus rules are considerably more involved than
...
Where a patch set proposes to change the Varsechain consensus, it must have been
...
The review process is normally fairly responsive on the Varsechain Core repository, however
...
The project leader is the release manager for each Varsechain Core release.
