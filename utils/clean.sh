...
rm -f src/config/varsechain-config.h
...
rm -rf test_bitcoin.coverage/ varsechain-gtest.coverage/ total.coverage/
...
clean_exe src/varsechain-cli
clean_exe src/varsechaind
clean_exe src/varsechain-gtest
clean_exe src/varsechain-tx
clean_exe src/test/test_varsechain
clean_exe src/test/test_varsechain_fuzzy
...
clean_dep . src/config/varsechain-config.h.in
